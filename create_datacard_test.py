...
if __name__ == '__main__':
    ...
    parser.add_argument('--add-blinded', default=False, help='add sideband region pairs or not')
    ...
    for fitbin in binNames:
        ...
        create_datacard(args.inputfile, realdir, args.nbins, 0, nDataTFDict[fitbin], fitbin, "fail", add_blinded=args.add_blinded, include_ac=args.include_ac)
