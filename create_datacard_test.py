...
def create_datacard(inputfile, carddir, nbins, nMCTF, nDataTF, passBinName, failBinName):
    ...
    for region in ['pass'+passBinName, 'fail', 'SR'+passBinName, 'fitfail']:
        ...
        systs_name_in_cards = ['ttbarBin1Jet2PNetCut', 'FSRPartonShower', 'ISRPartonShower', 'ggHHPDFacc', 'ggHHQCDacc', 'CMS_pileup', 'CMS_JER', 'CMS_JES',
                               'CMS_JMS', 'CMS_JMR', 'ttJetsCorr', 'ttJetsBDTShape', 'ttJetsPNetShape', 'PNetHbbScaleFactors_uncorrelated', 'triggerEffSF_uncorrelated']
...
if __name__ == '__main__':
    ...
    create_datacard(args.inputfile, "cards/"+args.carddir+"/cards_Bin1", args.nbins, 0, 0, "Bin1", "fail")
    create_datacard(args.inputfile, "cards/"+args.carddir+"/cards_Bin2", args.nbins, 0, 1, "Bin2", "fail")
    create_datacard(args.inputfile, "cards/"+args.carddir+"/cards_Bin3", args.nbins, 0, 0, "Bin3", "fail")
