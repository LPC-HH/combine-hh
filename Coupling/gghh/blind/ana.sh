...
dcdir=../../workspace/cards/$1

combineCards.py fitfail=${dcdir}/cards_Bin1/HHModel/fitfail.txt fail=${dcdir}/cards_Bin1/HHModel/fail.txt SRBin1=${dcdir}/cards_Bin1/HHModel/SRBin1.txt SRBin2=${dcdir}/cards_Bin2/HHModel/SRBin2.txt SRBin3=${dcdir}/cards_Bin3/HHModel/SRBin3.txt passBin1=${dcdir}/cards_Bin1/HHModel/passBin1.txt passBin2=${dcdir}/cards_Bin2/HHModel/passBin2.txt passBin3=${dcdir}/cards_Bin3/HHModel/passBin3.txt > ${ws}.txt
